...
const NAV_COMMANDS: NavCommand[] = [
  ...
  { patterns: ["production entry", "production floor", "meals produced"], to: "/production-entry-new", label: "Production Entry" },
  { patterns: ["production order", "production schedule", "production plan"], to: "/production-entry",  label: "Production Order" },
